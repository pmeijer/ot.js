...
function WrappedClient(revision, logger) {
    'use strict';
    var log = logger ? logger.debug : console.log;

    function Client(revision_) {
        this.revision = revision_; // the next expected revision number
